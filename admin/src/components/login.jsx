...
const Login = ({setToken}) => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center w-full'>
        ...
        <h2 className='text-4xl font-serif text-[#053342] text-center'>Login</h2>
            <form onSubmit={onSubmitHandler}>
                <div className='mb-3 min-w-72'>
                    <p className='text-md font-medium font-serif text-gray-700 text-[#053342] mb-2'>Email Address:</p>
                ...
                <div className='mb-3 min-w-72'>
                    <p className='text-md font-medium font-serif text-gray-700 text-[#053342] mb-2'>Password:</p>
                ...
                <button className='mt-2 w-full py-2 px-4 rounded-md text-white bg-black bg-[#053342]' type="submit"> Login </button>
            </form>
        </div>
    </div>
  )
