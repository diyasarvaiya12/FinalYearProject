...
const cart = () => {
  ...
  return (
    <div className="border-t pt-14">
      ...
      <h2 className='text-4xl font-serif text-[#053342] '>~Your Cart~</h2>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-start gap-6">
                ...
                <div>
                  <p className="text-xs sm:text-lg font-medium  text-[#053342]">{productData.name}</p>
      ...
      <div className="flex justify-end my-20">
        <div className="w-full sm:w-[450px]">
          ...
          <div className="w-full text-end">
            <button onClick={() => navigate('/place-order')} className="bg-[#053342] text-white text-sm my-8 px-8 py-3 active:bg-gray-700"> 
              PROCEED TO CHECKOUT
            </button>
          </div>
        </div>
